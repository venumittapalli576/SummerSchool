...
public class OnlineEnglish extends AppCompatActivity {

    private CoordinatorLayout coordinatorLayout;
    private String TAG = OnlineEnglish.class.getSimpleName();
    ...
    ArrayList<HashMap<String, String>> OnlineEnglishList;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_online_english);
        OnlineEnglishList = new ArrayList<>();
    ...
    protected class GetDetails extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(OnlineEnglish.this);
        ...
        protected void onPostExecute(Void result) {
             ...
             * */
            adapter = new CustomAdapter(getApplicationContext(), OnlineEnglishList, R.layout.activity_list_item,
