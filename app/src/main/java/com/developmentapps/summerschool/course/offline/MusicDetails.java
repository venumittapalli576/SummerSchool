...
public class MusicDetails extends AppCompatActivity {
    ...
    private static String url = "http://192.168.43.81/summerportal/viewdetails/MusicDetails.php";
    ...
    protected class GetDetails extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
             ...
             * */
            adapter = new SimpleAdapter(MusicDetails.this, MusicList, R.layout.activity_list_item,
