...
public class MusicDetails extends AppCompatActivity {
    ...
    private String TAG = MusicDetails.class.getSimpleName();
    private ProgressDialog pDialog;
    private ListView lv;
    CustomAdapter adapter;


    private static String url = "http://192.168.43.240/summerportal/viewdetails/MusicDetails.php";
    ...
    protected class GetDetails extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(MusicDetails.this);
        ...
        protected void onPostExecute(Void result) {
             ...
             * */
            adapter = new CustomAdapter(getApplicationContext(), MusicList, R.layout.activity_list_item,
