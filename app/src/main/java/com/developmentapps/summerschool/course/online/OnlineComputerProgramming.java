...
public class OnlineComputerProgramming extends AppCompatActivity {

    private CoordinatorLayout coordinatorLayout;
    private String TAG = OnlineComputerProgramming .class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_online_computer_programming);
        cList = new ArrayList<>();
    ...
    protected class GetDetails extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(OnlineComputerProgramming .this);
        ...
        protected void onPostExecute(Void result) {
             ...
             * */
            adapter = new CustomAdapter(getApplicationContext(),cList, R.layout.activity_list_item,
