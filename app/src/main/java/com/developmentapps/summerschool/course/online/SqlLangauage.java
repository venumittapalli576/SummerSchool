...
public class SqlLangauage extends AppCompatActivity {
    private CoordinatorLayout coordinatorLayout;
    private String TAG =  SqlLangauage.class.getSimpleName();
    ...
    ArrayList<HashMap<String, String>>  SqlLangauageList;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sql_langauage);
        SqlLangauageList = new ArrayList<>();
    ...
    protected class GetDetails extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog( SqlLangauage.this);
        ...
        protected void onPostExecute(Void result) {
             ...
             * */
            adapter = new CustomAdapter(getApplicationContext(), SqlLangauageList, R.layout.activity_list_item,
