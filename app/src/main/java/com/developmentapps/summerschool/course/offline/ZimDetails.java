...
public class ZimDetails extends AppCompatActivity {
    ...
    private static String url = "http://192.168.43.240/summerportal/viewdetails/ZimDetails.php";
    ...
    protected class GetDetails extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
             ...
             * */
            adapter = new CustomAdapter(getApplicationContext(), ZimList, R.layout.activity_list_item,
