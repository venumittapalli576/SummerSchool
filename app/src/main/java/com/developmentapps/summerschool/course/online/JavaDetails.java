...
public class JavaDetails extends AppCompatActivity {
    private CoordinatorLayout coordinatorLayout;
    private String TAG = JavaDetails.class.getSimpleName();
    ...
    ArrayList<HashMap<String, String>> javaList;
    ...
    protected class GetDetails extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(JavaDetails.this);
        ...
        protected void onPostExecute(Void result) {
             ...
             * */
            adapter = new CustomAdapter(getApplicationContext(), javaList, R.layout.activity_list_item,
