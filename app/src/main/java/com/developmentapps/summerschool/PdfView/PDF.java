package com.developmentapps.summerschool.PdfView;
...
public class PDF extends AppCompatActivity {
    ...
    public static class GridViewAdapter extends BaseAdapter {
        ...
        public View getView(int pos, View view, ViewGroup viewGroup) {
            ...
            if (pdf.getPdfURL() != null && pdf.getPdfURL().length() > 0) {
                Picasso.get().load(pdf.getPdfIconURL()).placeholder(R.drawable.craftson).into(pdfIcon);
            } else {
                Toast.makeText(c, "Empty Image URL", Toast.LENGTH_LONG).show();
                Picasso.get().load(R.drawable.craftson).into(pdfIcon);
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRetrieve.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new JSONDownloader(PDF.this).retrieve(myGridView, myProgressBar);
            }
        });
    }
}
